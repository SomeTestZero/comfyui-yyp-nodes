...
NODE_CLASS_MAPPINGS = {**_FREE_C, **_SAGE_C, **_RES_C, **_PLAN_C, **_CHAIN_C, **_LIFT_C, **_BANK_C, **_LRSZ_C, **_RSMC_C, **_KR2X_C}
NODE_DISPLAY_NAME_MAPPINGS = {**_FREE_D, **_SAGE_D, **_RES_D, **_PLAN_D, **_CHAIN_D, **_LIFT_D, **_BANK_D, **_LRSZ_D, **_RSMC_D, **_KR2X_D}
